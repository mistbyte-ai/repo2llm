...
function renderSnapshot(root, result) {
	...
	console.log(`Estimated tokens: ~${tokens.normal} - ${tokens.conservative}`)
	console.log('')
	console.log('===== LLM CONTEXT NOTE =====')
	console.log('This snapshot represents the current state of the repository.')
	console.log('Future diff snapshots in this conversation may contain updated')
	console.log('versions of some files.')
	console.log('When a diff snapshot provides a file, it replaces the previous')
	console.log('version of that file.')
	console.log('Files not present in a diff remain unchanged.')
	console.log('Always treat the most recent version of a file as authoritative.')
	console.log('')
...
function renderDiff(root, entries, hasUserIgnore, generatedAt) {
	...
	console.log('')
	console.log('===== LLM CONTEXT NOTE =====')
	console.log('This diff snapshot contains updated versions of changed files only.')
	console.log('When a file appears in this diff, it replaces the previous')
	console.log('version of that file in the conversation context.')
	console.log('Files not present in this diff remain unchanged.')
	console.log('Deleted files should be treated as removed from the project.')
	console.log('Always treat the most recent version of a file as authoritative.')
	console.log('Do not merge old and new versions of the same file.')
	console.log('')
